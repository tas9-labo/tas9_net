...
- **載せるもの**：名前・読み・屋号・拠点（京都/長野）・肩書・メール・公開OKの代表作（PROFILE で太字のタイトル）・
  主要ツール・個人開発の一言。
- **載せないもの**：電話番号・住所・非公開案件（PROFILE でタイトル「—」のもの）・学校名・PROFILE 本体。
  公開リポなので秘密は一切置かない。
...
| ファイル | 役割 |
|---|---|
| `index.html` | 名刺ページ本体。**外部読み込みゼロの1ファイル完結**（会場の弱い電波でも開くため。フォントもCDNも使わない） |
