...
- 見出し：最上段に **+9 ロゴ 70px**（右寄せ・上 6px の余白）。ロゴの真下に**ほんのり映り込み**（`.logo-mirror`＝同じパスを `<use>` で上下反転・不透明度 14%・下側 42% だけをグラデーションで残す。高さ 22px を確保）。その下の行に左から**キャラアイコン 44px**、名前 28px、その下にふりがな「/」英名。
