...
- **載せるもの**（2026-09-16 夜時点の構成・上から順）：
  ...
  ②ボタン行＝右詰めで「（✉ 丸）［連絡先に追加］」
  ③About＝**年表4行**（2002 業界へ／2009 モデラー→モーション／2019 独立・屋号 +9／2025 学校名＋講師を兼任（本業はフリーランスのまま、と読めるように「兼任」を付ける））＋小さな注記1行（頼める仕事の範囲＝業務委託・リモート）＋**説明3行**（会社員14年・キャラクターを動かす仕事→独立後の道具づくり→いまの暮らし。職制の歩み（モデラー→モーション→リード）は年表と Works 注記に任せ、ここでは繰り返さない（京都・長野／制作・教育・AI）で締める。生い立ち風の書き方はしない）
